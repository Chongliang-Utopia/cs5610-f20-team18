                ...
                <table className="table table-hover">
                    ...
                    {reviewsUserReceived.filter(review => review.reviewerIsLender).map((review, index) =>
                        <tr key={index}>
                            <td>
                                <Link
                                    to={isLoggedIn && LoggedInUser._id === review.reviewer._id ? `/profile` : `/profile/${review.reviewer._id}`}
                ...
                <ListGroup variant="flush">
                    {
                        UserFollowings.map((follow, index) =>
                            <ListGroup.Item className="pl-0" key={index}>
                                ...
                                />
                                <Link
                                    to={isLoggedIn && LoggedInUser._id === follow._id ? `/profile` : `/profile/${follow._id}`}>{follow.username}</Link>
