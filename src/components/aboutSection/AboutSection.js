            ...
            <div className="col-md-6">
                <div className={classes.aboutParagraph}>
                    <h4>
                        ...
                        inspired
                        to
                        facilitate book lovers to share books within the neighborhoods. We hope to help promote
                        everyone’s
                        reading
                        habits, as well as saving natural resources by recirculating books.
                    </h4>
                </div>
            </div>
            <div className="col-md-6">
